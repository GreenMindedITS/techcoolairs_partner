            ...
            <div class="row">
                <div class="col-md-6 col-6 pl-5 pr-3">
                    <div class="info-box shadow">
                        <span class="info-box-icon bg-gmis-infobox text-white"><i class="far fa-envelope"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">Add Technician</span>
                        </div>
                        <div class="info-box-content info-box-gmis">
                            <span class="info-box-text info-box-text-gmis">8</span>
                        </div>
                    </div>
